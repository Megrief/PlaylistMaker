...
import com.example.playlistmaker.ui.search.utils.ItemClickDebouncer
import com.example.playlistmaker.ui.search.utils.adapter.TrackAdapter
import com.example.playlistmaker.ui.search.vm.SearchScreeenState
    ...
    private val onTrackClicked: (Track) -> Unit by lazy {
        {
            if (ItemClickDebouncer.clickDebounce()) {
                ...
                (binding.historyList.adapter as TrackAdapter).notifyDataSetChanged() // история не обновляется!!
