...
class AudiolayerViewModel(
    trackInteractor: StorageInteractor<Track?>,
    application: App
        ...
        fun getViewModelFactory(): ViewModelProvider.Factory {
            return viewModelFactory {
                initializer {
                    ...
                    val storageInteractor = Creator.createStorageInteractorTrack(context)
                    AudiolayerViewModel(storageInteractor, application)
                }
            }
        }
    }
